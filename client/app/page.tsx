          ...
          <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <img src={data?.user?.image || "/vercel.svg"} alt={data?.user?.name || "User"} width={120} height={120}
            ...
            <div className="space-y-3 text-center">
              <h1 className="text-3xl font-bold text-zinc-50 truncat"> Welcome, {data?.user?.name || "User"} </h1>
